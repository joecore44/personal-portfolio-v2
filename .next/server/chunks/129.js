...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8271);
...
const AboutSection = ()=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_5__.useQuery)("information", _fetchers__WEBPACK_IMPORTED_MODULE_4__/* .getInformation */ .H9);
    if (isLoading) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "block py-20 text-center",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_utils__WEBPACK_IMPORTED_MODULE_6__/* .Spinner */ .$j, {})
    });
    if (!data) return null;
                    ...
                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                ...
                                alt: data.fullName,
                                placeholder: "blur",
                                blurDataURL: `data:image/svg+xml;base64,${(0,_lib_utils__WEBPACK_IMPORTED_MODULE_7__/* .toBase64 */ .s3)((0,_lib_utils__WEBPACK_IMPORTED_MODULE_7__/* .shimmer */ .f8)(660, 422))}`
                            })
                        ]
                    })
                })
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8271);
...
const BlogSection = ()=>{
    ...
    const { error , loading , data  } = (0,_hooks_useGetPosts__WEBPACK_IMPORTED_MODULE_6__/* .getPosts */ .J)();
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(swiper_react__WEBPACK_IMPORTED_MODULE_3__.Swiper, {
                ...
                children: postsData && postsData.map((post, index)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(swiper_react__WEBPACK_IMPORTED_MODULE_3__.SwiperSlide, {
...
const ContactForm = ()=>{
    ...
    const { 0: serverSuccess , 1: setServerSuccess  } = useState("");
    const { 0: serverError , 1: setServerError  } = useState("");
    const { register , handleSubmit , formState: { errors  } ,  } = useForm();
    const onSubmit = (data)=>{
        emailjs.sendForm(settings.emailjs_serviceid, settings.emailjs_templateid, currentForm.current, settings.emailjs_publickey).then((result)=>{
        ...
        children: [
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    errors.name && /*#__PURE__*/ _jsx(_Fragment, {
                        children: errors.name.type === "required" && /*#__PURE__*/ _jsx("p", {
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    errors.email && /*#__PURE__*/ _jsxs(_Fragment, {
                        children: [
                            errors.email.type === "required" && /*#__PURE__*/ _jsx("p", {
                                className: "bg-red-500 bg-opacity-5 text-center text-sm text-red-500",
                                children: "Email is required!"
                            }),
                            errors.email.type === "pattern" && /*#__PURE__*/ _jsx("p", {
                                className: "bg-red-500 bg-opacity-5 text-center text-sm text-red-500",
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    errors.subject && /*#__PURE__*/ _jsx(_Fragment, {
                        children: errors.subject.type === "required" && /*#__PURE__*/ _jsx("p", {
                            className: "bg-red-500 bg-opacity-5 text-center text-sm text-red-500",
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    ...
                    errors.message && /*#__PURE__*/ _jsx(_Fragment, {
                        children: errors.message.type === "required" && /*#__PURE__*/ _jsx("p", {
                            className: "bg-red-500 bg-opacity-5 text-center text-sm text-red-500",
            ...
            !serverSuccess && serverError && /*#__PURE__*/ _jsx("p", {
                className: "bg-red-500 bg-opacity-5 text-center text-sm text-red-500",
                children: serverError
            }),
            !serverError && serverSuccess && /*#__PURE__*/ _jsx("p", {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8271);
/* harmony import */ var _ContactForm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8323);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([framer_motion__WEBPACK_IMPORTED_MODULE_1__, _ContactForm__WEBPACK_IMPORTED_MODULE_8__]);
([framer_motion__WEBPACK_IMPORTED_MODULE_1__, _ContactForm__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const ContactSection = ()=>{
    ...
    if (isLoading) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "block py-20 text-center",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_utils__WEBPACK_IMPORTED_MODULE_7__/* .Spinner */ .$j, {})
    });
    if (!data) return null;
            ...
            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                        children: "If you have a dev project in mind, feel free to reach out."
                    }),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("p", {
                                                className: "mb-0",
                                                children: "\uD83C\uDFD4 Northern Arizona, United States"
                                            })
                                        ]
                                    })
                                ]
...
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3841);
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(4646);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(8271);
...
const HeroSection = ({ blurred , scroll =true , typed =true  })=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_7__.useQuery)("information", _fetchers__WEBPACK_IMPORTED_MODULE_8__/* .getInformation */ .H9);
    if (isLoading) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "flex min-h-screen w-full items-center justify-center py-20 text-center",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_utils__WEBPACK_IMPORTED_MODULE_10__/* .Spinner */ .$j, {})
    });
    if (!data) return null;
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                                ...
                                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_image__WEBPACK_IMPORTED_MODULE_1___default()), {
                                                    loader: _lib_utils__WEBPACK_IMPORTED_MODULE_11__/* .imageLoader */ .XI,
                                                    unoptimized: true,
                                                    src: data.thumbImage,
                                                    alt: data.fullName,
                                                    height: 150,
                                                    ...
                                                    layout: "responsive",
                                                    placeholder: "blur",
                                                    blurDataURL: `data:image/svg+xml;base64,${(0,_lib_utils__WEBPACK_IMPORTED_MODULE_11__/* .toBase64 */ .s3)((0,_lib_utils__WEBPACK_IMPORTED_MODULE_11__/* .shimmer */ .f8)(150, 150))}`
                                                })
                                            })
                                        ]
                                    }),
...
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3841);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8271);
/* harmony import */ var _hooks_useGetPosts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4337);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([framer_motion__WEBPACK_IMPORTED_MODULE_1__, _elements__WEBPACK_IMPORTED_MODULE_5__]);
([framer_motion__WEBPACK_IMPORTED_MODULE_1__, _elements__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const PortfoliosSection = ()=>{
    ...
    const { error , isLoading , data  } = (0,_hooks_useGetPosts__WEBPACK_IMPORTED_MODULE_7__/* .getPosts */ .J)();
...
const ReviewsSection = ()=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)("clientreviews", _fetchers__WEBPACK_IMPORTED_MODULE_5__/* .getClientReviews */ .Vf);
    const sliderRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
    const handlePrev = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(()=>{
        if (!sliderRef.current) return;
        sliderRef.current.swiper.slidePrev();
...
const ServicesSection = ()=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)("services", _fetchers__WEBPACK_IMPORTED_MODULE_3__/* .getServices */ .U2);
    if (isLoading) return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: "block py-20 text-center",
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_utils__WEBPACK_IMPORTED_MODULE_6__/* .Spinner */ .$j, {})
    });
