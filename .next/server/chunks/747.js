...
/* harmony export */ });
/* unused harmony exports getPostsPath, getPagesPath, getSinglePost */
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5629);
/* harmony import */ var _hooks_useGetPosts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4337);
...
const getAllPostsData = ()=>{
    ...
    return posts.sort(___WEBPACK_IMPORTED_MODULE_4__/* .sortPostByDate */ .Ar);
};
// Get posts by page
const getPostsByPage = (page = 1, limit = 6)=>{
    const tempPosts = getAllPostsData();
    const posts = (0,___WEBPACK_IMPORTED_MODULE_4__/* .filterPostsByPage */ .E)(tempPosts, page, limit);
    return {
        posts,
...
const getCategoryPaths = ()=>{
    ...
    const paths = categories.map((category)=>{
        const filteredPosts = allPosts.filter((post)=>{
            const temp = post.category.map((cat)=>(0,___WEBPACK_IMPORTED_MODULE_4__/* .createSlug */ .qi)(cat)
            );
...
const getPostsByCategory = (category, page = 1, limit = 6)=>{
    ...
    const posts = (0,___WEBPACK_IMPORTED_MODULE_4__/* .filterPostsByPage */ .E)(filteredPosts, page, limit);
    return {
        posts,
