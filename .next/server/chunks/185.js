                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                    ...
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_2___default()), {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                            ...
                            children: categories.nodes[0].name
                        })
                    })
                })
            })
...
/* harmony import */ var _hooks_useGetPosts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4337);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([framer_motion__WEBPACK_IMPORTED_MODULE_3__, swiper_react__WEBPACK_IMPORTED_MODULE_5__]);
([framer_motion__WEBPACK_IMPORTED_MODULE_3__, swiper_react__WEBPACK_IMPORTED_MODULE_5__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const Blog = ()=>{
    ...
    return /*#__PURE__*/ _jsx(_Fragment, {
        children: data.posts.nodes.map((post, index)=>{
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Cq": () => (/* reexport safe */ _Review__WEBPACK_IMPORTED_MODULE_5__.Z),
/* harmony export */   "HE": () => (/* reexport safe */ _SocialIcons__WEBPACK_IMPORTED_MODULE_7__.Z),
/* harmony export */   "_3": () => (/* reexport safe */ _ProgressCircle__WEBPACK_IMPORTED_MODULE_4__.Z),
/* harmony export */   "_Y": () => (/* reexport safe */ _Portfolio__WEBPACK_IMPORTED_MODULE_2__.Z),
/* harmony export */   "aG": () => (/* reexport safe */ _Breadcrumb__WEBPACK_IMPORTED_MODULE_9__.Z),
/* harmony export */   "jq": () => (/* reexport safe */ _TimelineItem__WEBPACK_IMPORTED_MODULE_8__.Z),
/* harmony export */   "ko": () => (/* reexport safe */ _ProgressBar__WEBPACK_IMPORTED_MODULE_3__.Z),
/* harmony export */   "l3": () => (/* reexport safe */ _Blog__WEBPACK_IMPORTED_MODULE_0__.Z),
/* harmony export */   "t6": () => (/* reexport safe */ _Service__WEBPACK_IMPORTED_MODULE_6__.Z)
/* harmony export */ });
/* harmony import */ var _Blog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4899);
/* harmony import */ var _BlogHome__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2923);
/* harmony import */ var _Portfolio__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5292);
/* harmony import */ var _ProgressBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7894);
/* harmony import */ var _ProgressCircle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3300);
/* harmony import */ var _Review__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3985);
/* harmony import */ var _Service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8805);
/* harmony import */ var _SocialIcons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(5282);
/* harmony import */ var _TimelineItem__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8179);
/* harmony import */ var _Breadcrumb__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(3904);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_BlogHome__WEBPACK_IMPORTED_MODULE_1__, _ProgressBar__WEBPACK_IMPORTED_MODULE_3__, _ProgressCircle__WEBPACK_IMPORTED_MODULE_4__]);
([_BlogHome__WEBPACK_IMPORTED_MODULE_1__, _ProgressBar__WEBPACK_IMPORTED_MODULE_3__, _ProgressCircle__WEBPACK_IMPORTED_MODULE_4__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const Footer = ()=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)("information", _fetchers__WEBPACK_IMPORTED_MODULE_3__/* .getInformation */ .H9);
    if (!data) return null;
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_1___default()), {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                                    ...
                                    children: "JoeShepard.dev"
                                })
                            })
                        ]
                    }),
                    "Built with Next.js against a Headless WP install using GraphQL \uD83E\uDDE0 \uD83D\uDCA1."
                ]
            })
        })
    });
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(8271);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8271);
...
const Sidemenu = ({ fullMenu , fullMenuHandler  })=>{
    const { data , isLoading  } = (0,react_query__WEBPACK_IMPORTED_MODULE_4__.useQuery)("information", _fetchers__WEBPACK_IMPORTED_MODULE_5__/* .getInformation */ .H9);
    if (!data) return null;
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
...
;// CONCATENATED MODULE: ./src/components/utils/Spinner.jsx
...
/* harmony default export */ const utils_Spinner = (Spinner_Spinner);

// EXTERNAL MODULE: external "react"
var external_react_ = __webpack_require__(6689);
// EXTERNAL MODULE: external "disqus-react"
var external_disqus_react_ = __webpack_require__(1527);
;// CONCATENATED MODULE: ./src/components/utils/Comments.jsx
...
const Comments = ({ title , slug  })=>{
    ...
    return /*#__PURE__*/ _jsx(DiscussionEmbed, {
        shortname: process.env.NEXT_PUBLIC_DISCUSS_SHORTNAME,
        config: {
            url: "https://personal-portfolio-v2-nu.vercel.app",
            identifier: slug,
            title: title
        }
    });
};
/* harmony default export */ const utils_Comments = ((/* unused pure expression or super */ null && (Comments)));
...
const http_http = external_axios_default().create({
    baseURL: "/api",
    headers: {
...
const getInformation = async ()=>{
    let res = await http_http.get(`/information.json`);
    return res.data;
};
const getServices = async ()=>{
    let res = await http_http.get(`/services.json`);
    return res.data;
};
const getTechskills = async ()=>{
    let res = await http_http.get(`/techskills.json`);
    return res.data;
};
const getLanguageskills = async ()=>{
    let res = await http_http.get(`/languageskills.json`);
    return res.data;
};
const getPortfolioFilters = async ()=>{
    let res = await http_http.get(`/portfoliofilters.json`);
    return res.data;
};
...
const getJobExperience = async ()=>{
    let res = await http_http.get(`/jobexperience.json`);
    return res.data;
};
const getEducationBackground = async ()=>{
    let res = await http_http.get(`/educationbackground.json`);
    return res.data;
};
const getClientReviews = async ()=>{
    let res = await http_http.get(`/clientsreview.json`);
    return res.data;
};
...
`;
const getPosts = ()=>{
    const { error , data , loading  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_0__.useQuery)(GET_POSTS);
    return {
        error,
        data,
        loading
